#!/usr/bin/env python3
\"\"\"Extract hourly bars from a Snappy Symbols DB for one symbol and compare
close values to entries in a signals JSONL file (for testing extraction correctness).

This is a read-only tool that does not modify DBs or `logs/signals.jsonl`.
\"\"\"
